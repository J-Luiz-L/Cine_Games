...
- **Conceitos POO:** Implementa o encapsulamento dos atributos sensíveis (como `horas_jogadas` e `avaliacao`) utilizando o decorator `@property` para garantir a integridade dos dados e aplicar validações.
...
- **Conceitos POO:** Demonstra a *Herança Simples* (Generalização/Especialização).
